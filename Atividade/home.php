...
<body>
            ...
            <div class="collapse navbar-collapse" id="navbarNavDropdown">
                <ul class="navbar-nav">
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown"> Menu
                        </a>
    ...
    <div class="container mt-4">
        ...
        <p align="center">Navegue no pelo nosso menu explorando nossas funcionalidadess</p>
    </div>
